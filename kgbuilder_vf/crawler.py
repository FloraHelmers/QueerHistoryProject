...
#USA,Germany
#should add a way to recover the property linking people to these entities (less searching for SPARQL) : done, test
...
def crawler_process(G, n_iter, k_prop, n_incr, policy, n_max=None, people_list=[], alpha=0.85, pagerank_iter=100):
    ...
    for i in range(n_iter):
        ...
        print(to_expl)
        dict_to_expl={prop:get_incoming_properties(prop)[0] for prop in to_expl}
